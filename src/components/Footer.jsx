...
import fb from '/Audiophile/images/shared/desktop/icon-facebook.svg'
import twitter from '/Audiophile/images/shared/desktop/icon-twitter.svg'
import ig from '/Audiophile/images/shared/desktop/icon-instagram.svg'
